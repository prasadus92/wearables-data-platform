 ...
 * mints a pairing code here, enters it in the Vital Connect bridge app, and
...
export function ConnectAppleScreen() {
  ...
  function goDevices() {
    // The pairing finishes in the Vital Connect app, so there is no success
        ...
        <View className="rounded-[29px] bg-card p-5">
          {phase.name === 'intro' ? (
              ...
              <View className="mt-2.5">
                <SheetBody>
                  {demoMode
                    ...
                    : 'Your watch shares data through the Health app on your iPhone. Get a pairing code, enter it in the Vital Connect app, and grant Health access.'}
                </SheetBody>
              </View>
              {demoMode ? (
            ...
            <Animated.View entering={enter(0)}>
              ...
              <View className="mt-2.5">
                <SheetTitle>Enter this code in Vital Connect</SheetTitle>
              </View>
              ...
              <View className="mt-5 gap-3">
                <Step
                  n={1}
                  text="Install the Vital Connect app from the App Store."
                />
