...
class JunctionClient:
    ...
    async def create_link_code(self, junction_user_id: str) -> dict[str, Any]:
        """Mint a single-use pairing code for the Vital Connect bridge app.
        ...
        return await self._request(
            "POST", "/v2/link/code/create", params={"user_id": junction_user_id}
        )
