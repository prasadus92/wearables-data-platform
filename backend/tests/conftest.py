...
os.environ.setdefault(
    "DATABASE_URL", "postgresql+asyncpg://youth:youth@localhost:5432/wearables_test"
)
os.environ.setdefault("REDIS_URL", "redis://localhost:6379/1")
os.environ.setdefault("JUNCTION_API_KEY", "sk_eu_test_key")
os.environ.setdefault("JUNCTION_WEBHOOK_SECRET", "")  # signature tests set their own
...
def _create_test_database():
    ...
    async def ensure() -> None:
        conn = await asyncpg.connect("postgresql://youth:youth@localhost:5432/postgres")
